...
func main() {
	...
	for _, pkg := range pkgs {
		...
		g.Printf("//go:generate enumgen %s\n", strings.Join(os.Args[1:], " "))
		g.Printf("// Code generated by \"enumgen %s\"; DO NOT EDIT.\n", strings.Join(os.Args[1:], " "))
		g.Printf("// use go install github.com/yikakia/enumgen to install it.\n")
		g.Printf("// See more at: https://pkg.go.dev/github.com/yikakia/enumgen\n")
		g.Printf("\n")
